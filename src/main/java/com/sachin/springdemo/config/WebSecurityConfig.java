...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
      ...
      .antMatchers("/swagger-ui.html/**", "/h2-console/**", "/console/**").permitAll()
      .antMatchers("/swagger-ui/**", "/webjars/**", "/v2/api-docs", "/configuration/**", "/swagger-resources/**").permitAll()
      .antMatchers("/api/swagger-ui/**").permitAll()
      .antMatchers("/resources/**").permitAll()
      .antMatchers("/WEB-INF/view/**").permitAll()
      .antMatchers("/showMyLoginPage/**", "/authenticateTheUser/**", "/register/**", "/customer/**", "/access-denied").permitAll()
